...
<div class="mypage">
    ...
    <div data-ng-controller="mainctrl" ng-view="">
       <?php echo form_open_multipart('home/save_advtax_liability', array('id' => 'basic_frm','class'=>'form-horizontal adminex-form' ,'enctype'=>'multipart/form-data')); ?>
            ...
            <div class="tabpane">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12 text-right next-tab-nav">
                        ...
                        <a type="button" class="btn btn-default" href="<?php echo base_url('home/advtax_liability_list'); ?>">Back</a>

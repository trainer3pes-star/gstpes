...
<?php endif; ?>
        ...
        <div class="col-md-6 col-md-offset-3">
            <h1 class="text-center">Register</h1>
             <?php echo form_open_multipart('home/save_user', array('id' => 'user_basic_frm','class'=>'form-horizontal adminex-form' ,'enctype'=>'multipart/form-data')); ?>
                <!--<input type="hidden" name="csrfmiddlewaretoken" value="za5vohQZx91BcjSfjzThEFqnWJcxGX2apPMpKrkYPjtyAxuiToSTCUPigSJjZZqm">-->
                ...
                <div class="form-group">
                    <label for="id_course" class="col-sm-4 control-label">Which course are you learning in Practical Eduskills?</label>
                    <div class="col-sm-8">
                        <select name="course" class="form-control" required="" id="id_course">
                            ...
                            <option value="AI BSC">AI BSC</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="id_password2" class="col-sm-4 control-label">Password confirmation:</label>
                    <div class="col-sm-8">
                        <input type="password" name="confirm_password" autocomplete="new-password" class="form-control animate-on-focus" required="" id="confirm_password">

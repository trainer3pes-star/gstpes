...
<div class="mypage">
        ...
        <div class="col-xs-10">
            <div data-breadcrumb="" name="Home">
                <ol class="breadcrumb" data-ng-controller="crumbCtrl">
                    ...
                    <li data-ng-repeat="breadcrumb in breadcrumbs.getAll()"><ng-switch on="$last"> <!----> <!----><span ng-switch-default=""><a href="/gst/registration/" data-ng-bind="breadcrumb.n" target="_self">Registration</a></span><!----> </ng-switch></li><!---->
                    <li data-ng-repeat="breadcrumb in breadcrumbs.getAll()"><ng-switch on="$last"> <!----><span ng-switch-when="true">Verify</span><!----> <!----> </ng-switch></li><!---->
                </ol>
            </div>
        </div>
        <div class="col-xs-2">
    ...
    <div class="content-pane" style="min-height: 444px;">
        <!---->
        <div ng-view="">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <form role="form" class="col-sm-offset-2 col-md-offset-3 col-md-6 col-sm-8 col-xs-12 ng-valid-maxlength ng-dirty ng-valid-parse ng-valid-required ng-valid-pattern ng-valid ng-valid-minlength ng-submitted ng-hide" name="preg" data-ng-submit="validateOtp()" data-accessible-form="" data-ng-show="!successmsg" autocomplete="off" novalidate="">
                                ...
                                <div class="form-group col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" data-ng-class="{'has-error': form_submitted &amp;&amp; preg.mobile_otp.$invalid,
                                            ...
                                            <!----><label class="reg m-cir" for="mobile_otp" data-ng-if="!plogin.trn || plogin.trn.length == 0" data-ng-bind="trans.LBL_OTP_MOBILE">Mobile OTP</label><!---->
                                            <!---->
                                            <div class="form-group has-feedback">
                                                <input type="password" id="mobile_otp" class="form-control ng-valid-maxlength ng-not-empty ng-dirty ng-valid-parse ng-valid-required ng-valid-pattern ng-valid ng-valid-minlength ng-touched" data-ng-model="plogin.smsOtp" name="mobile_otp" minlength="6" maxlength="6" data-ng-pattern="/^[0-9]{6}$/" required="" autofocus="" autocomplete="off" fdprocessedid="vjrm5p">
                                        ...
                                        <!---->
                                        <div data-ng-if="!plogin.trn || plogin.trn.length == 0" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" data-ng-class="{'has-error': form_submitted &amp;&amp; preg.email_otp.$invalid,'has-success': form_submitted &amp;&amp; preg.email_otp.$valid}">
                                            <label class="reg m-cir" for="email-otp" data-ng-bind="trans.LBL_OTP_EMAIL">Email OTP</label>
                                            <div class="form-group has-feedback">
                                                <input type="password" id="email-otp" class="form-control ng-valid-maxlength ng-not-empty ng-dirty ng-valid-parse ng-valid-required ng-valid-pattern ng-valid ng-valid-minlength ng-touched" name="email_otp" data-ng-model="plogin.emailOtp" minlength="6" maxlength="6" data-ng-pattern="/^[0-9]{6}$/" required="" fdprocessedid="yw3p1z">
                                                <!---->
                                                <!---->
                                                <span class="help-block">
                                                    <p><i class="fa fa-info-circle"></i> <span data-ng-bind="trans.HLP_OTP_EMAIL">Enter OTP sent to your
                                                            Email Address</span></p>
                                                    <p><i class="fa fa-info-circle"></i> <span> Please check the
                                                            junk/spam folder in case you do not get email.</span></p>
                                                </span>
                                            </div>
                                        </div><!---->
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 text-right">
                                <a class="btn btn-default" data-ng-bind="trans.LBL_BACK" ng-click="setTrnPage(plogin.trn)">Back</a>
                    ...
                    <div class="row" data-ng-show="successmsg">
                        <div class="col-sm-12">
                            <p class="alert alert-success" style="margin-top: 15px;">
                                ...
                                <span data-ng-bind="trn">0703104076TRN</span>.
                            </p>
                            <span>Using this TRN you can access the application from My saved Applications and submit on
                                GST Portal.</span>
                            <?php
                            $expiry_date = date('M d, Y', strtotime('+15 days'));
                            ?>
                            
                            <span>
                            Part B of the application form needs to be completed within 15 days, i.e. by 
                            <?php echo $expiry_date; ?> using this TRN.
                            </span>
                    ...
                    <div class="row" data-ng-show="successmsg">
                        <div class="col-sm-12 text-right">
                            ...
                            <a class="btn btn-primary" ng-click="setTrnPage(plogin.trn)" href="business_details">Proceed</a>
                        </div>
                    </div>
                </div>
            </div>

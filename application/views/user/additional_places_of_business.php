...
?>
 ...
 <?php echo form_open_multipart('home/save_additional_places_of_business', array('id' => 'basic_frm','class'=>'form-horizontal adminex-form tabpane ng-pristine ng-valid-pattern ng-valid-maxlength ng-invalid' ,'enctype'=>'multipart/form-data')); ?>
            <fieldset>

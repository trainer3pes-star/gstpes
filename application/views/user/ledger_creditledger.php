...
<div class="mypage">
            ...
            <div data-breadcrumb="" name="Dashboard">
                <ol class="breadcrumb" data-ng-controller="crumbCtrl">
                    ...
                    <li data-ng-repeat="breadcrumb in breadcrumbs.getAll()">
                        <ng-switch on="$last">
                            <!----><span ng-switch-when="true">Ledger</span>
                            <!---->
                            <!---->
                        </ng-switch>
                    </li>
    ...
    <div class="row invsumm">
        <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 taxp">
            <h4>Electronic Credit Ledger</h4><span> <?php echo ucwords($resultTaxpayer->name); ?> &nbsp;<?php echo $resultTaxpayer->gstno; ?></span>
        </div>
    </div>
    <div data-ng-controller="ledctrl1">
        <div class="content-pane" data-ng-init="landingPageMethod()" style="min-height: 232.2px;">
            <div class="rettbl-format">
                <div class="row">
                    <div class="col-xs-12 col-sm-3">
                        <p><b data-ng-bind="trans.LBL_FIN_YEAR">Financial Year</b></p>
                        <span class="dispblock">2025-26</span>
                    </div>
                    <div class="col-xs-12 col-sm-3">
                        <p><b data-ng-bind="trans.LBL_MONTH">Month</b></p>
                        <span class="dispblock">June</span>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <p><b>ITC Balance As On Date : 11-06-2025</b></p>
                        <span class="reg">₹ 40.00</span>
                        <!--
<span class="dispblock" data-ng-if="cashBalanceDetails.op_tot != 0">&#8377; <a class="inverseLink" data-toggle="modal" data-target="#balanceModal" ></a></span>
<span class="reg" data-ng-if="cashBalanceDetails.op_tot == 0" ></span>
-->
                    </div>
                </div>
            </div>
            ...
            <div class="rettbl-format">
                <div class="row">
                    <div class="col-sm-12">
                        <!--<h4 class="txtblack" data-ng-bind="trans.LBL_LED_VIEW"></h4>-->
                        <br>
                        <ol>
                            <li>
                                <a class="inverseLink" target="_self" href="ledger_creditledgerdetails">Electronic Credit Ledger</a>
                            </li>
                            <li>
                                <a class="inverseLink" target="_self" href="ledger_creditledgerprovisional" >Provisional Credit Balance : 0.00</a>
                                <!--data-ng-bind="trans.LBL_PROV_ITC"-->
                            </li>
                            <li>
                                <a class="inverseLink" target="_self" href="ledger_creditledgerprovisional">Blocked Credit Balance : 0.00</a>
                                <!--data-ng-bind="trans.LBL_PROV_ITC"-->
                            </li>
                        </ol>
                    </div>

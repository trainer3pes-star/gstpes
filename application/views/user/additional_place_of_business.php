...
?>
                    ...
                    <div class="col-sm-3 col-xs-12 appperc">
                        ...
                        <p class="date" data-ng-bind="pfilled+'%'">60%</p>
                    </div>
                </div>
            </div>
            <ul class="nav nav-tabs responsive r1 reg-tabs" data-ng-class="{'adhr' : rpayload.bkacdtls}">
                ...
                <li data-ng-class="statusClass(6)" class="active  incomplete ">
                    <a><span class="navicon abplace navicon fa fa-map-marker-alt fa-2x"></span><br>Additional Places of
                        Business</a>
                </li>
...
<?php echo form_open_multipart('home/save_additional_place_of_business', array('id' => 'basic_frm','class'=>'form-horizontal adminex-form tabpane ng-pristine ng-valid-pattern ng-valid-maxlength ng-invalid' ,'enctype'=>'multipart/form-data')); ?>
            <!---->
            <h4><span data-ng-bind="trans.HEAD_ADNL_PLC">Details of Additional Places of your Business</span></h4>
            <!----><div data-ng-if="!showForm"> 
                <!----><div class="row" data-ng-if="!rpayload.ppbzdtls.hasaddl || rpayload.ppbzdtls.hasaddl == 'N'">
                    <div class="col-xs-4" id="additional_places_container">
                                                    <label class="reg m-cir" for="pncd" data-ng-bind="trans.LBL_PIN_CODE">Number Of Additional Places</label>
                            <input type="text" name="number_of_additional_places" maxlength="10" class="form-control" id="id_number_of_additional_places">
                    </div>
                </div><!---->
                <!---->
                <div class="row next-tab-nav">
                    <div class="col-xs-12 text-right ">
                        <a title="Back" class="btn btn-default" data-ng-bind="trans.LBL_BACK" href="principle_place_of_business">Back</a>
...
<!--    Add New-->
<!--</button>-->
                         <button title="Save &amp; Continue" type="submit" name="action" value="add_new" class="btn btn-primary" > Continue</button>
                        <!-- <a class="btn btn-primary" data-ng-bind="trans.LBL_CONTINUE" data-ng-disabled="rpayload.adbzdtls && rpayload.napb && (rpayload.adbzdtls.length < rpayload.napb)" href="auth/newappl/goodsservices"></a> -->
                    </div>
                </div>
            </div><!---->
            <!---->

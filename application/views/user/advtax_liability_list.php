        ...
        <div class="col-xs-10">
            <div data-breadcrumb="" name="Dashboard">
                <ol class="breadcrumb" data-ng-controller="crumbCtrl">
                    ...
                    <li>
                        <ng-switch on="$last">
                            <span ng-switch-when="true">Tax Liability (Advances Received)</span>
                        </ng-switch>
                    </li>
                </ol>
            </div>
        ...
        <div class="container" data-ng-init="getExportInv()">
            ...
            <div class="row invsumm">
                <div class="col-xs-12 col-sm-12 taxp">
                    <h4>Tax Liability (Advances Received) - Summary</h4>
    ...
    margin-top: 0px;"><i class="fa fa-refresh" aria-hidden="true"></i></button>
            ...
            <div class="tabpane">
                            ...
                            <table id="example_php" class="table table-bordered table-striped  col-xs-12" >
								...
								<tbody>
									...
									<tr  >
										...
										<a class="btn btn-xs btn-info" href="advtax_liability_add/<?php echo $result->invoice_id?>" title="Edit"><i class="fas fa-pencil-alt "></i></a>
										<a class="btn btn-xs btn-danger confirm_delete" href="advtax_liability_delete/<?php echo $result->invoice_id ?>" title="Delete"><i class="fa fa-trash"></i></a>
                ...
                <div class="btn-toolbar">
                                        <button onclick="location.href='advtax_liability_add'" type="button" class="btn btn-primary pull-right" data-ng-click="goToAddExp()">Add state wise details</button>

        ...
        <div data-ng-init="B2bInvoice()">
            ...
            <div class="row invsumm">
                <div class="col-xs-12 col-sm-12 taxp">
                    <h4 data-ng-bind="trans.LBL_B2B_INV_SUMRY">9B - Credit / Debit Notes (Registered)</h4>
            ...
            <div class="tabpane">
                ...
                <div class="row" data-ng-if="b2binvdt.processedInvoice">
                    ...
                    'sort-desc': params.sorting()[$column.sortable(this)]=='desc'
                                            ...
                                            <div ng-if="!template" class="ng-table-header" ng-class="{'sort-indicator': params.settings().sortingIndicator == 'div'}"> <span ng-bind="$column.title(this)" ng-class="{'sort-indicator': params.settings().sortingIndicator == 'span'}" class="sort-indicator">Note No.</span> </div>
                    ...
                    'sort-desc': params.sorting()[$column.sortable(this)]=='desc'
                                            ...
                                            <div ng-if="!template" class="ng-table-header" ng-class="{'sort-indicator': params.settings().sortingIndicator == 'div'}"> <span ng-bind="$column.title(this)" ng-class="{'sort-indicator': params.settings().sortingIndicator == 'span'}" class="sort-indicator">Note Date</span> </div>
                    ...
                    'sort-desc': params.sorting()[$column.sortable(this)]=='desc'
                                            ...
                                            <div ng-if="!template" class="ng-table-header" ng-class="{'sort-indicator': params.settings().sortingIndicator == 'div'}"> <span ng-bind="$column.title(this)" ng-class="{'sort-indicator': params.settings().sortingIndicator == 'span'}" class="sort-indicator">Note Value</span> </div>
                    ...
                    'sort-desc': params.sorting()[$column.sortable(this)]=='desc'
                               ...
                               <tbody class="text-center">
                                   ...
                                   <tr>
                                      <td><?php echo $result->note_no;?></td>
                                     <td><?php echo date('d/m/Y', strtotime($result->note_date)); ?></td>
                                     <td><?php echo $result->note_value; ?></td>
                                     ...
                                     <td><a class="btn btn-xs btn-danger confirm_delete" href="<?php echo base_url('home/register_delete'); ?>/<?php echo $result->invoice_id ?>"
 title="Delete"><i class="fa fa-trash"></i></a></td>
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12 text-right next-tab-nav">
                        <button onclick="location.href='<?php echo base_url('home/registered_summary_list'); ?>'"

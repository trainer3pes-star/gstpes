        ...
        <div class="col-xs-10">
            <div data-breadcrumb="" name="Dashboard">
                <ol class="breadcrumb" data-ng-controller="crumbCtrl">
                    ...
                    <li>
                        <ng-switch on="$last">
                            <span ng-switch-when="true">Credit/Debit Notes (Unregistered)</span>
                        </ng-switch>
                    </li>
                </ol>
            </div>
    ...
    margin-top: 0px;"><i class="fa fa-refresh" aria-hidden="true"></i></button>
            ...
            <div class="tabpane">
                            ...
                            <table id="example_php" class="table table-bordered table-striped  col-xs-12" >
								...
								<tbody>
									...
									<tr  >
										...
										<td><?php echo date(DISPLAY_DATE,strtotime($result->note_date));?></td> 
										<td><?php echo $result->note_value;?></td> 
										<td><?php echo $result->note_type;?></td>
										...
										<a class="btn btn-xs btn-info" href="unregistered_noteadd/<?php echo $result->invoice_id?>" title="Edit"><i class="fas fa-pencil-alt "></i></a>
										<a class="btn btn-xs btn-danger confirm_delete" href="unregistered_note_delete/<?php echo $result->invoice_id ?>" title="Delete"><i class="fa fa-trash"></i></a>
                ...
                <div class="btn-toolbar">
                                        <button onclick="location.href='unregistered_noteadd'" type="button" class="btn btn-primary pull-right" data-ng-click="goToAddExp()">Add Details</button>

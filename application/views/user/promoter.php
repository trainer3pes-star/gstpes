...
<div class="mypage">
  ...
  <tr>
    <th><label for="id_middle_name">Middle Name:</label></th>
    <td>
  ...
  <tr>
    <th><label for="id_father_first_name">Father&#x27;s Name:</label></th>
    <td>
      
      <input type="text" name="father_first_name" maxlength="200" class="form-control" id="id_father_first_name">
  ...
  <tr>
    <th><label for="id_father_middle_name">Father&#x27;s Middle Name:</label></th>
    <td>
      
      <input type="text" name="father_middle_name" maxlength="200" class="form-control" id="id_father_middle_name">
  ...
  <tr>
    <th><label for="id_father_last_name">Father&#x27;s Last Name:</label></th>
    <td>
      
      <input type="text" name="father_last_name" maxlength="200" class="form-control" id="id_father_last_name">
  ...
  <tr>
    ...
    <label for="id_gender_0"><input type="radio" name="gender" value="-1" required id="id_gender_0" checked>
 Select</label>

</div><div>
    <label for="id_gender_1"><input type="radio" name="gender" value="0" required id="id_gender_1">
 Male</label>

</div><div>
    <label for="id_gender_2"><input type="radio" name="gender" value="1" required id="id_gender_2">
 Female</label>

</div><div>
    <label for="id_gender_3"><input type="radio" name="gender" value="2" required id="id_gender_3">
 Other</label>
  ...
  <tr>
    <th><label for="id_telephone_std">Telephone std:</label></th>
    <td>
  ...
  <tr>
    <th><label for="id_telephone_number">Telephone number:</label></th>
    <td>
  ...
  <tr>
    <th><label for="id_designation">Designation:</label></th>
    <td>
      
      <input type="text" name="designation" maxlength="100" class="form-control" id="id_designation">
  ...
  <tr>
    <th><label for="id_director_number">Director Number:</label></th>
    <td>
      
      <input type="text" name="director_number" maxlength="50" class="form-control" id="id_director_number">
  ...
  <tr>
    <th><label for="id_citizen_of_india">Are you a Citizen of India:</label></th>
    <td>
      
      <input type="checkbox" name="citizen_of_india" class="form-control" id="id_citizen_of_india" checked>
  ...
  <tr>
    <th><label for="id_pan">PAN:</label></th>
    <td>
  ...
  <tr>
    <th><label for="id_passport">Passport:</label></th>
    <td>
      
      <input type="text" name="passport" maxlength="20" class="form-control" id="id_passport">
  ...
  <tr>
    <th><label for="id_aadhar">Aadhar:</label></th>
    <td>
      
      <input type="text" name="aadhar" maxlength="12" class="form-control" id="id_aadhar">
  ...
  <tr>
    ...
    <td>
      ...
      <input type="text" name="country" maxlength="100" class="form-control" id="id_country">
  ...
  <tr>
    <th><label for="id_pin">PIN:</label></th>
    <td>
  ...
  <tr>
    ...
    <td>
      ...
      <input type="text" name="state" maxlength="50" class="form-control" id="id_state">
  ...
  <tr>
    <th><label for="id_locality">Locality:</label></th>
    <td>
  ...
  <tr>
    <th><label for="id_road">Road:</label></th>
    <td>
  ...
  <tr>
    <th><label for="id_name_of_building">Name of Building:</label></th>
    <td>
  ...
  <tr>
    <th><label for="id_building_number">Building Number:</label></th>
    <td>
  ...
  <tr>
    <th><label for="id_floor_number">Floor Number:</label></th>
    <td>
  ...
  <tr>
    <th><label for="id_nearby_landmark">Nearby Landmark:</label></th>
    <td>
  ...
  <tr>
    <th><label for="id_date_of_birth_custom">Date of birth custom:</label></th>
    <td>
      
      <input type="text" name="date_of_birth_custom" class="form-control" required id="id_date_of_birth_custom">
        ...
        <div class="col-xs-10">
            <div data-breadcrumb="" data-target="_self" name="Dashboard">
                <ol class="breadcrumb" data-ng-controller="crumbCtrl">
                    ...
                    <li data-ng-repeat="breadcrumb in breadcrumbs.getAll()"><ng-switch on="$last"> <span ng-switch-when="true">Promoter</span>  </ng-switch></li>
                </ol>
            </div>
        </div>
        <div class="col-xs-2">
...
?>
                    ...
                    <div class="col-sm-3 col-xs-12 appperc">
                        ...
                        <p class="date" data-ng-bind="pfilled+'%'">24%</p>
                    </div>
                </div>
            </div>
            <ul class="nav nav-tabs responsive r1 reg-tabs" data-ng-class="{'adhr' : rpayload.bkacdtls}">
                ...
                <li data-ng-class="statusClass(2)" class="active  incomplete ">
                    <a data-ng-click="tabroute(2)"><span class="navicon partners navicon fa fa-user-tie fa-2x"></span>Promoter / Partners</a>
                </li>
 ...
 <?php echo form_open_multipart('home/save_promoter', array('id' => 'basic_frm','class'=>'form-horizontal adminex-form tabpane ng-pristine ng-valid-pattern ng-valid-maxlength ng-invalid' ,'enctype'=>'multipart/form-data')); ?>
            ...
            <h4 data-ng-repeat="x in promoter | filter:{c: rpayload.bzdtls.bzdtlsbz.cobz}" data-ng-if="rpayload.bzdtls.bzdtlsbz.cobz">
                <span data-ng-bind="trans.LBL_DET_PRO">Details of Proprietor</span>
            </h4>
            <hr>
            ...
            <div data-ng-show="showForm">
                <fieldset data-ng-disabled="((['DFT','VAE'].indexOf(rpayload.rgdtls.aplst) &lt; 0 || multiReg ) &amp;&amp; !clrPayload) ||
                                        ( clrPayload &amp;&amp; isMigratedMail !='Y' &amp;&amp; (['CLR','DCL','VAE'].indexOf(clrPayload.rgdtls.aplst) &lt; 0 || (['CLR','DCL','VAE'].indexOf(clrPayload.rgdtls.aplst) &gt;= 0 &amp;&amp; !allowAllFieldsToEdit &amp;&amp; (scnDetails.pp.attrDtlsFliClr |  ordinal: 'eid' : pd.eid).length  0)))"> 
                    <h4>
                            ...
                            <div class="inner">
                                <div class="col-sm-4 col-xs-12" data-ng-class="{'has-error': pdsubmit &amp;&amp; !newRegForm.dob.$valid, 'has-success': pdsubmit &amp;&amp; newRegForm.dob.$valid}">
                                    ...
                                    <div class="datepicker-icon input-group">
                                        ...
                                        <!--  -->
                                        <input type="date" name="date_of_birth_custom" class="form-control" required="" id="id_date_of_birth_custom">
                        ...
                        <div class="inner">
                            <div class="col-sm-4 col-xs-12 radio-order" data-ng-class="{'has-error': pdsubmit &amp;&amp; !newRegForm.gd.$valid, 'has-success': pdsubmit &amp;&amp; newRegForm.gd.$valid}">
                                <fieldset data-ng-disabled="clrPayload &amp;&amp; !allowAllFieldsToEdit &amp;&amp; ((scnDetails.pp.attrDtlsFliClr | ordinal: 'fieldId' : 'FLD008')| ordinal: 'eid' : pd.eid).length  0">
                                    ...
                                    <input type="radio" name="gender" id="id_gender_1" data-ng-model="pd.gd" value="0" data-ng-checked="pd.gd" data-radio-chbx="" required="" data-ng-change="setPristine('gd')" class="ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required">
                                    <label for="id_gender_1">
                                        <i class="type-ico fa fa-male"></i>
                                        <span data-ng-bind="trans.LBL_MALE">Male</span>
                                    </label>
                                    <input type="radio" name="gender" id="id_gender_2" data-ng-model="pd.gd" value="1" data-ng-checked="pd.gd" data-radio-chbx="" required="" data-ng-change="setPristine('gd')" class="ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required">
                                    <label for="id_gender_2">
                                        <i class="type-ico fa fa-female"></i>
                                        <span data-ng-bind="trans.LBL_FEMALE">Female</span>
                                    </label>
                                    <input type="radio" name="gender" id="id_gender_3" data-ng-model="pd.gd" value="2" data-ng-checked="pd.gd" data-radio-chbx="" required="" data-ng-change="setPristine('gd')" class="ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required">
                        ...
                        <div class="inner">
                            ...
                            <div class="col-sm-4 col-xs-12">
                                ...
                                <div class="switch round">
                                    <input id="pd_cit_ind" name="pd_cit_ind" type="checkbox" data-ng-model="pd.iscitind" data-ng-checked="(pd.iscitind'Y')?true:false" data-ng-true-value="'Y'" data-ng-false-value="'N'" data-ng-disabled="clrPayload &amp;&amp; !allowAllFieldsToEdit &amp;&amp; ((scnDetails.pp.attrDtlsFliClr | ordinal: 'fieldId' : 'FLD010')| ordinal: 'eid' : pd.eid).length  0" data-ng-change="setPristine('pan');setPristine('ppno')" class="ng-pristine ng-untouched ng-valid ng-not-empty" checked="checked">
                    ...
                    <div class="row">
                        <div class="inner">
                            ...
                            <div class="col-sm-4 col-xs-12" data-ng-class="{'has-error':pdsubmit &amp;&amp; newRegForm.uid.$invalid}">
                                ...
                                <input name="aadhar_card" id="id_aadhar_card" class="form-control" placeholder="Enter Aadhaar Number">
                    ...
                    <div class="row">
                        <div class="inner">
                            ...
                            <div class="col-sm-6 col-xs-12">
                                ...
                                <!--data-ng-bind="trans.LBL_PER_PHOTO" already commented-->
                                ...
                                <p class="help-block">
                                    ...
                                    <input id="pd_upload" name="pd_upload" type="file" accept=".jpeg" data-max-size="102400">
                                    <p class="err" data-ng-bind="errVar"></p><div class="progress ng-hide" data-ng-show="uploading"><div class="progress-bar"  role="progressbar" style="width:"></div></div>
                                
                                
                            </div> 
                            <div class="col-sm-6 col-xs-12" data-ng-if="hasWebcam &amp;&amp; (!pd.dcupdtls || pd.dcupdtls.length  0 ) &amp;&amp; !clrPayload &amp;&amp; !pd.isNewSignatoryDetailsAfterSCN">
                                <div class="row">
                                    ...
                                    <!-- <div class="col-xs-10">
                                        <data-photo-model id="selfie" name="selfie" data-appl-id="35452861" data-doc-type="PHOT" data-callback="upcamera(resp)">
                                            <div class="col-xs-12 text-center">
                                                <div class="vsc-controller vsc-nosource"></div>
                                                <button ng-click="openCamera()" id="takePhoto" title="Take Picture" type="button" class="btn btn-primary" data-ng-if="(videoStreams | numkeys).length  0 && !captured">
                                                    <i class="fa fa-camera"></i> Take Picture
                                                </button>
                                                <p data-ng-if="(videoStreams | numkeys).length  0 && !captured" style="font-size: 12px;">
                                                    <span class="fa fa-info-circle"></span>
                                                    You can use your device camera to take a selfie photograph.
                                                </p>
                                                <video id="videoselfie" name="selfie" width="240" height="200" autoplay=""></video>
                                                <canvas id="canvasselfie" width="240" height="200"></canvas>
                                            </div>
                                            <div class="col-xs-12 text-center">
                                                <button class="btn btn-primary" ng-click="captureCamera()" type="button">Capture</button>
                                                <button type="button" ng-click="tryagain()" class="btn btn-primary">Try Again</button>
                                                <button type="button" ng-click="upload()" class="btn btn-primary">Upload</button>
                                                <p class="err" data-ng-bind="err"></p>
                                            </div>
                                        </data-photo-model>
                                    </div> -->
                            ...
                            <!-- CR 22668 Changes Start -->
                            
                            
                            
                            <!-- CR 22668 Changes End -->
                        </div>
                    </div>
                    
                    
                </div>
                <h4 data-ng-bind="trans.HEAD_OTHR_INFO">Other Information</h4>
                <div class="tbl-format">
                    <div class="row">
                        <div class="col-xs-12">
                            <label class="reg" for="pri_auth" data-ng-bind="trans.LBL_ALSO_AUTH">Also Authorized Signatory</label>
                            <div class="switch round">
                                <input id="pri_auth" name="pri_auth" type="checkbox" data-ng-model="pd.isasg" data-ng-checked="(pd.isasg 'Y')?true:false" data-radio-chbx="" data-ng-disabled="clrPayload &amp;&amp; !pd.isNewSignatoryDetailsAfterSCN" class="ng-pristine ng-untouched ng-valid ng-empty">
                                <label for="pri_auth">
                                ...
                                <!-- 
                                <label for="id_also_authorised_signatory">
                                    <span class="switch-on" style="left:4px"><span data-ng-bind="trans.LBL_YES">Yes</span></span>
                                    <span class="switch-off" style="left:35px"><span data-ng-bind="trans.LBL_NO">No</span></span>
                                </label> -->
                            </div>
                            <input name="also_authorised_signatory" id="id_also_authorised_signatory" value="0" style="display:none;">
                        </div>
                    </div>
                </div>
            </fieldset>
            ...
            <div class="row next-tab-nav">
                <div class="col-xs-12 text-right">
                    <a title="Back" class="btn btn-default" href="business_details">Back</a>
...
<script>
function goToList() {
    window.location.href = "<?= base_url('home/promotor_list'); ?>";
}
</script>

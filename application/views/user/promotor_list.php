    ...
    <div class="content-pane" data-ng-controller="dashboardctrl" style="min-height: 444px;">
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                <!---->
                <h4 data-ng-bind="trans.HEAD_MY_SAVEDAPP">Promoter List</h4>
                <!---->
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="table-responsive" data-ng-if="savedata &amp;&amp; savedata.length &gt; 0">
                    <table class="table table-vertical-align thead-dark table-hover table-bordered">
                        <thead>
                            <tr>
                                <th width="15%" class="vrtcl-midl text-center">Name</th>
                                <th class="vrtcl-midl text-center">Father Name</th>
                                <th class="vrtcl-midl text-center">Date of Birth </th>
                                <th class="vrtcl-midl text-center">Mobile</th>
                                <th class="vrtcl-midl text-center">Email</th>
                                <th class="vrtcl-midl text-center">Designation </th>
                                 <th class="vrtcl-midl text-center">PAN </th>
                            </tr>
                        </thead>
                        <tbody>
                            <!---->
                           ...
                           <td>
                                <?php echo $result->first_name . ' ' . $result->middle_name . ' ' . $result->last_name; ?>
                                                        ...
                                                        <td>
                                <?php echo $result->father_first_name . ' ' . $result->father_middle_name . ' ' . $result->father_last_name; ?>
                            </td>
                            <td>
                                <?php echo date('d-m-Y', strtotime($result->date_of_birth_custom)); ?>
                            </td>
                            <td>

        ...
        <div ng-view="">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <div role="form" class="col-sm-offset-2 col-md-offset-3 col-md-6 col-sm-8 col-xs-12 ng-invalid ng-invalid-required ng-valid-maxlength ng-dirty ng-valid-parse ng-invalid-pattern ng-invalid-minlength" name="preg" data-ng-submit="validateOtp()" data-accessible-form="" data-ng-show="!successmsg" autocomplete="off" novalidate="" method="post" action="/gst/registration/otp-verify/">
                        ...
                        <p class="mand-text" data-ng-bind="trans.HLP_MAND_FIELD">indicates mandatory fields</p>
                         <?php echo form_open_multipart('home/save_trn_otp', array('id' => 'basic_frm','class'=>'form-horizontal adminex-form' ,'enctype'=>'multipart/form-data')); ?>
                                            ...
                                            <div class="form-group has-feedback">
                                                ...
                                                <!----><span data-ng-if="!plogin.trn || plogin.trn.length == 0" class="help-block">
                                                    <i class="fa fa-info-circle"></i> <span data-ng-bind="trans.HLP_OTP_MOBILE">Enter OTP sent to your
                                                        Mobile and Email</span></span><!---->
                                                        <p class="help-block"><i class="fa fa-info-circle"></i> <span> Please check the junk/spam folder in case you do not get email.</span></p>
                                                        <!---->
                                            </div>
                                        </div><!---->

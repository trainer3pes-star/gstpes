    ...
    <div ng-view="">
        <div data-ng-include="'/pages/registration/newrg/regtabs.html'">
            ...
            <div class="row regapp">
                <div class="col-xs-12 col-sm-12">
                    ...
                    <div class="col-sm-3 col-xs-12 appperc">
                        ...
                        <p class="date" data-ng-bind="pfilled+'%'">80%</p>
                    </div>
                </div>
            </div>
            <ul class="nav nav-tabs responsive r1 reg-tabs" data-ng-class="{'adhr' : rpayload.bkacdtls}">
                ...
                <li data-ng-class="statusClass(8)" class="active  incomplete ">
                ...
                <li data-ng-class="statusClass(9)" class=" incomplete ">
                    <a href="/gst/registration/step-9/"><span class="navicon fa fa-id-card fa-2x"></span><br>Aadhaar
                        Authentication</a>
                </li>
                <li data-ng-class="statusClass(10)" class=" incomplete ">
        ...
        <form class="tabpane ng-pristine ng-valid ng-valid-pattern ng-valid-maxlength" name="newRegForm" id="newRegForm" data-ng-submit="stateDetails()" data-accessible-form="" autocomplete="off" novalidate="" action="bank_account" method="post">
            <input type="hidden" name="csrfmiddlewaretoken" value="YonyNI3VL3DyIFasZD80mrWDc2hbYWlfysjd2LnZF2U7Rzjb7kXVovlHhDwjZm34">
            <h4 data-ng-bind="trans.HEAD_STATE_SINFO">State Specific Information</h4>
            <div class="tbl-format">
                <fieldset data-ng-disabled="(['DFT','VAE'].indexOf(rpayload.rgdtls.aplst) &lt; 0 &amp;&amp; !clrPayload)||(clrPayload &amp;&amp; !allowAllFieldsToEdit &amp;&amp; (['CLR','DCL','VAE'].indexOf(clrPayload.rgdtls.aplst) &lt; 0 || !scnDetails.ss))">
                    <div class="row">
                        <div class="inner">
                            <!---->
                        </div>
                    ...
                    <div class="row">
                        <div class="inner">
                            <div class="col-sm-6 col-xs-12" data-ng-class="{'has-error': stsubmit &amp;&amp; newRegForm.ec_tax.$invalid, 'has-success': stsubmit &amp;&amp; newRegForm.ec_tax.$valid}">
                                <label class="reg" for="ec_tax" data-ng-bind="trans.LBL_PTAX_ECN">Professional Tax Employee Code (EC) No.</label>
                                <input type="text" name="professional_tax_employee_code" maxlength="50" class="form-control" id="id_professional_tax_employee_code">
                                <!-- <input id="ec_tax" name="ec_tax" class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-pattern ng-valid-maxlength" data-ng-model="stsidtls.ptecnum" placeholder="Enter Professions Tax E.C Number" maxlength="20" data-ng-pattern="/^[a-zA-Z0-9\_&amp;\'\-\.\/\,()?@!#%$~*;+= ]*[a-zA-Z0-9!#$%&amp;'*+\/=?^_`{|}~-\s]{1,99}$/"> -->
                                <!---->
                            </div>
                            <div class="col-sm-6 col-xs-12" data-ng-class="{'has-error': stsubmit &amp;&amp; newRegForm.rc_tax.$invalid, 'has-success': stsubmit &amp;&amp; newRegForm.rc_tax.$valid}">
                                <label class="reg" for="rc_tax" data-ng-bind="trans.LBL_PTAX_RCN">Professional Tax Registration Certificate (RC) No.</label>
                                <input type="text" name="professional_tax_registration_certificate" maxlength="50" class="form-control" id="id_professional_tax_registration_certificate">
                                <!-- <input id="rc_tax" name="rc_tax" class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-pattern ng-valid-maxlength" data-ng-model="stsidtls.ptrcnum" placeholder="Enter Professions Tax R.C Number" maxlength="20" data-ng-pattern="/^[a-zA-Z0-9\_&amp;\'\-\.\/\,()?@!#%$~*;+= ]*[a-zA-Z0-9!#$%&amp;'*+\/=?^_`{|}~-\s]{1,99}$/"> -->
                                <!---->
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="inner">
                            <div class="col-sm-6 col-xs-12" data-ng-class="{'has-error': stsubmit &amp;&amp; newRegForm.lic_no.$invalid, 'has-success': stsubmit &amp;&amp; newRegForm.lic_no.$valid}">
                                <label class="reg" for="lic_no" data-ng-bind="trans.LBL_ST_ELN">State Excise License No.</label>
                                <input type="text" name="state_excise_license" maxlength="50" class="form-control" id="id_state_excise_license">
                                <!-- <input id="lic_no" name="lic_no" class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-pattern ng-valid-maxlength" data-ng-model="stsidtls.stexlcnum" placeholder="Enter State Excise License Number" maxlength="20" data-ng-pattern="/^[a-zA-Z0-9\_&amp;\'\-\.\/\,()?@!#%$~*;+= ]*[a-zA-Z0-9!#$%&amp;'*+\/=?^_`{|}~-\s]{1,99}$/"> -->
                                <!---->
                            </div>
                            <div class="col-sm-6 col-xs-12" data-ng-class="{'has-error': stsubmit &amp;&amp; newRegForm.per_lic_no.$invalid, 'has-success': stsubmit &amp;&amp; newRegForm.per_lic_no.$valid}">
                                <label class="reg" for="per_lic_no" data-ng-bind="trans.LBL_NMP_EL">Name of the person in whose name Excise Licence is held</label>
                                <input type="text" name="name_of_the_person_in_whose_name_excise_licence_is_held" maxlength="50" class="form-control" id="id_name_of_the_person_in_whose_name_excise_licence_is_held">
                                <!-- <input id="per_lic_no" name="per_lic_no" class="form-control ng-pristine ng-untouched ng-valid ng-empty ng-valid-pattern ng-valid-maxlength" data-ng-model="stsidtls.exlcnm" placeholder="Enter Name of the Person in whose name Excise License is held" maxlength="99" data-ng-pattern="/^[a-zA-Z0-9\_&amp;\'\-\.\/\,()?@!#%$~*;+= ]*[a-zA-Z0-9!#$%&amp;'*+\/=?^_`{|}~-\s]{1,99}$/"> -->
                                <!---->
                            </div>
                        </div>
                    </div>
            ...
            <div class="row next-tab-nav">
                <div class="inner">
                    <div class="col-xs-12 text-right">
                        <!---->
                        <a title="Back" class="btn btn-default" href="good_service">Back</a>
                        <!-- <a title="Back" class="btn btn-default" data-ng-bind="trans.LBL_BACK" href="/gst/registration/saved-applications/">Back</a> -->
                                                 <button onclick="location.href='bank_account'" class="btn btn-primary">
                        Save &amp; Continue
                    </button>   
                        <!--Start: Defect fix for 2089  -->
                        <!---->
                        <!--End: Defect fix for 2089  -->
                    </div>
                </div>
            </div>
        </form>

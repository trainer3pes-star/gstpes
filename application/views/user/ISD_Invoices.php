    ...
    <div data-ng-controller="mainctrl" ng-view="">
        <div class="myPage" data-ng-init="isdpreview()">
            ...
            <div class="tabpane">
               ...
               <div class="row">
 <table class="table table-bordered table-striped"> <thead class="table-primary"> <tr> <th>GSTIN of Supplier</th> <th>Supplier Name</th> <th>GSTR-6 filing status</th> </tr> </thead> <tbody> <tr> <td>07ACQPG4437P8ZS</td> <td>BIR PRAKASH</td> <td>Y</td> </tr> </tbody> </table><div class="btn-container">
    <button class="btn btn-default">BACK</button>
    <button class="btn btn-primary">DOWNLOAD DOCUMENTS (CSV)</button>
</div> </div> </div> 
</div>
            </div>
        </div>

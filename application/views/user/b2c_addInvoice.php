...
<div class="mypage">
    ...
    <div data-ng-controller="mainctrl" ng-view="">
         <?php echo form_open_multipart('home/save_b2c_addInvoice', array('id' => 'basic_frm','class'=>'form-horizontal adminex-form' ,'enctype'=>'multipart/form-data')); ?>
                ...
                <div class="tbl-format rettbl-format">
                    ...
                    <div class="row">
                       <div class="col-sm-4">
                            ...
                            <input name="supply_type" class="form-control " id="id_supply_type" value="<?php echo @$result->supply_type?>" disabled>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                           ...
                           <input type="checkbox" class="chkbx" name="is_supplies" id="is_supplies" value="1" 
                                <?php echo (@$result->is_supplies == 1) ? 'checked' : ''; ?>>
                            <label for="is_supplies">
...
foreach ($rates as $index => $rate_value):
    ...
    $isMatch = ($rate_value == @$result_b2c_details->rate);
?>
<tr>
    ...
    <td class="text-center">
        <input id="taxable_value<?php echo $index; ?>" name="taxable_value[]" class="form-control"
            value="<?php echo $isMatch ? @$result_b2c_details->taxable_value : ''; ?>">
    </td>
    
    <td class="text-center">
        <input id="tax<?php echo $index; ?>" name="tax[]" class="form-control"
            value="<?php echo $isMatch ? @$result_b2c_details->tax : ''; ?>" readonly>
    </td>
    
    <td class="text-center">
        <input id="cess<?php echo $index; ?>" name="cess[]" class="form-control"
            value="<?php echo $isMatch ? @$result_b2c_details->cess : ''; ?>" readonly>
    </td>
</tr>
<?php endforeach; ?>
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12 text-right next-tab-nav">
                         <a type="button" class="btn btn-default" href="<?php echo base_url('home/b2c_summary'); ?>">Back</a>

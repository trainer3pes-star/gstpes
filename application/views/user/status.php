...
<div class="mypage">
    ...
    <div class="row" data-ng-controller="transctrl" data-ng-init="init('services')">
        <div class="col-xs-10">
            <div data-breadcrumb="" data-target="_self" data-="" data-name="Dashboard">
<ol class="breadcrumb" data-ng-controller="crumbCtrl">
                    <li><a target="" href="/" data-ng-bind="name">Dashboard</a></li><!---->
                    <li> <!----><span ng-switch-when="true"><a>Services</a></span><!----> <!----> </ng-switch></li><!---->
                    <li data-ng-repeat="breadcrumb in breadcrumbs.getAll()"><ng-switch on="$last"> <!----><span ng-switch-when="true">Track Application Status</span><!----> <!----> </ng-switch></li><!---->
                </ol>
            </div>
        </div>
    </div>
  <div class="content-pane" data-ng-controller="fowelcomectrl" style="min-height: 419.4px;">
    <div class="row">
      <div class=" col-xs-6">
    <h3>
      ...
      <div class="col-xs-12">
        ...
        <div class="col-md-4">
            <div class="form-box">
                ...
                <?php echo form_open('home/track_application_status'); ?>

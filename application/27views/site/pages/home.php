                            ...
                            <div class="banner-item">
                                <div class="banner-img img-zoom-effect">
                                    ...
                                    <div class="inner-content">
                                        ...
                                        <div class="button-wrap">
                                            <a class="btn btn-primary btn-white-hover rounded-0" href="shop.php">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="banner-item">
                                <div class="banner-img img-zoom-effect">
                                    ...
                                    <div class="inner-content">
                                        ...
                                        <div class="button-wrap">
                                            <a class="btn btn-custom-size btn-primary btn-white-hover rounded-0" href="shop.php">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="product-area product-style-2 section-space-y-axis-100">
            <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="product-item">
                            <div class="product-img img-zoom-effect">
                                <a href="single-product.php">
                                   <!--  <img class="img-full" src="assets/images/product/medium-size/1-1-270x300.jpg" alt="Product Images"> -->                                    <img class="img-full" src="assets/images/product/medium-size/single-product-1-530x480.webp" alt="Product Images">
                                </a>
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6 pt-6 pt-sm-0">
                        <div class="product-item">
                            <div class="product-img img-zoom-effect">
                                <a href="single-product.php">
                               <!--     <img class="img-full" src="assets/images/product/medium-size/1-2-270x300.jpg" alt="Product Images"> -->                                    <img class="img-full" src="assets/images/product/medium-size/single-product-2-530x480.jpg" alt="Product Images">
                                </a>
                                <div class="product-add-action">
                                    <ul>
                                        <li>
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6 pt-6 pt-lg-0">
                        <div class="product-item">
                            <div class="product-img img-zoom-effect">
                                <a href="single-product.php">
                                  <!--  <img class="img-full" src="assets/images/product/medium-size/1-3-270x300.jpg" alt="Product Images"> -->                                    <img class="img-full" src="assets/images/product/medium-size/single-product-1-530x480.webp" alt="Product Images">
                                </a>
                                <div class="product-add-action">
                                    <ul>
                                        <li>
				 ...
				 <div class="col-xl-3 col-lg-3 col-sm-6 pt-6 pt-lg-0">
                        <div class="product-item">
                            <div class="product-img img-zoom-effect">
                                <a href="single-product.php">
                                    <img class="img-full" src="assets/images/product/medium-size/single-product-2-530x480.jpg" alt="Product Images">                                    <!-- <img class="img-full" src="assets/images/product/medium-size/single-product-2-530x480.jpg" alt="Product Images"> -->
                                </a>
                                <div class="product-add-action">
                                    <ul>
                                        <li>
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6 pt-6">
                        <div class="product-item">
                            <div class="product-img img-zoom-effect">
                                <a href="single-product.php">
                                    <!-- <img class="img-full" src="assets/images/product/medium-size/1-5-270x300.jpg" alt="Product Images"> -->                                    <img class="img-full" src="assets/images/product/medium-size/single-product-1-530x480.webp" alt="Product Images">
                                </a>
                                <div class="product-add-action">
                                    <ul>
                                        <li>
                            ...
                            <div class="product-content">
                                <a class="product-name" href="single-product.php">Dried Lemon Green</a>
                                <div class="price-box pb-1">
                                    <span class="new-price">80.00 Rs</span>
                                </div>
                                <div class="rating-box">
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6 pt-6">
                        <div class="product-item">
                            <div class="product-img img-zoom-effect">
                                <a href="single-product.php">
                                    <img class="img-full" src="assets/images/product/medium-size/single-product-2-530x480.jpg" alt="Product Images">                             <!--       <img class="img-full" src="assets/images/product/medium-size/1-6-270x300.jpg" alt="Product Images"> -->
                                </a>
                                <div class="product-add-action">
                                    <ul>
                                        <li>
                            ...
                            <div class="product-content">
                                <a class="product-name" href="single-product.php">Natural Coconut</a>
                                <div class="price-box pb-1">
                                    <span class="new-price">80.00 Rs</span>
                                </div>
                                <div class="rating-box">
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6 pt-6">
                        <div class="product-item">
                            <div class="product-img img-zoom-effect">
                                <a href="single-product.php">
                                    <!-- <img class="img-full" src="assets/images/product/medium-size/1-7-270x300.jpg" alt="Product Images"> -->                                    <img class="img-full" src="assets/images/product/medium-size/single-product-1-530x480.webp" alt="Product Images">
                                </a>
                                <div class="product-add-action">
                                    <ul>
                                        <li>
                            ...
                            <div class="product-content">
                                <a class="product-name" href="single-product.php">Black Peppepr Read</a>
                                <div class="price-box pb-1">
                                    <span class="new-price">80.00 Rs</span>
                                </div>
                                <div class="rating-box">
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6 pt-6">
                        <div class="product-item">
                            <div class="product-img img-zoom-effect">
                                <a href="single-product.php">
                                    <!-- <img class="img-full" src="assets/images/product/medium-size/1-8-270x300.jpg" alt="Product Images"> -->                                    <img class="img-full" src="assets/images/product/medium-size/single-product-2-530x480.jpg" alt="Product Images">
                                </a>
                                <div class="product-add-action">
                                    <ul>
                                        <li>
        ...
        <!-- Begin Banner Area -->
        <!--<div class="banner-area banner-style-2 section-space-y-axis-100" data-bg-image="assets/images/banner/3-1-1920x582.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-content">
                            ...
                            <div class="price-box pb-6">
                                <span class="old-price text-danger">$20.00</span>
                                <span class="new-price text-primary">-$30.00</span>
                            </div>
                            ...
                            <div class="button-wrap pt-10">
                                <a class="btn btn-custom-size lg-size btn-primary btn-dark-hover rounded-0" href="shop.php">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Begin Shipping Area -->
        <div class="shipping-area section-space-top-100 section-space-bottom-95 bg1">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product-item">
                                        <div class="product-img img-zoom-effect">
                                            <a href="single-product.php">
                                                <img class="img-full" src="assets/images/product/small-size/1-product-263.png" alt="Product Images">
                                            </a>
                                            <div class="product-add-action">
                                                <ul>
                                                    <li>
                                        ...
                                        <div class="product-content">
                                            <a class="product-name" href="single-product.php">111 Black Pepper Grains</a>
                                            <div class="price-box pb-1">
                                                <span class="new-price">80.00 Rs</span>
                                            </div>
                                            <div class="rating-box">
                                ...
                                <div class="swiper-slide">
                                    <div class="product-item">
                                        <div class="product-img img-zoom-effect">
                                            <a href="single-product.php">
                                                <img class="img-full" src="assets/images/product/small-size/2-product-263.png" alt="Product Images">
                                            </a>
                                            <div class="product-add-action">
                                                <ul>
                                                    <li>
        ...
        <!-- Begin Banner Area -->
        <div class="banner-with-testimonial py-10" data-bg-image="assets/images/banner/2-1-1920x523.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <div class="testimonial-content section-title">
                                            ...
                                            <div class="user-info">
                                                <div class="user-img">
                                                    <img src="assets/images/brand/1-2.png" alt="User Image">
                                                </div>
                                                <div class="user-content">
                                                    <span class="user-name">Satvi Bhoote</span>
                                    ...
                                    <div class="testimonial-item">
                                        <div class="testimonial-content section-title">
                                            ...
                                            <div class="user-info">
                                                ...
                                                <div class="user-content">
                                                    <span class="user-name">Payal Sharma</span>
                                                    <span class="user-occupation">Customer</span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product-list-item">
                                        <div class="product-img img-zoom-effect">
                                            <a href="single-product.php">
                                                <img class="img-full" src="assets/images/product/small-size/small-110.png" alt="Product Images">
                                            </a>
                                        </div>
                                        <div class="product-content">
                                            <a class="product-name" href="single-product.php">Black Pepper Grains</a>
                                ...
                                <div class="swiper-slide">
                                    <div class="product-list-item">
                                        <div class="product-img img-zoom-effect">
                                            <a href="single-product.php">
                                                <img class="img-full" src="assets/images/product/small-size/small-2-110.png" alt="Product Images">
                                            </a>
                                        </div>
                                        <div class="product-content">
                                            <a class="product-name" href="single-product.php">Peanut Big Bean</a>
                                ...
                                <div class="swiper-slide">
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content">
                                            <a class="product-name" href="single-product.php">Green Vegetable</a>
                                            <div class="price-box pb-1">
                                                <span class="new-price">80.00 Rs</span>
                                            </div>
                                            <div class="rating-box-wrap">

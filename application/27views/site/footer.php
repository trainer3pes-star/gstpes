 <div class="popup" role="alert">  <div class="popup-container">    <a href="#0" class="popup-close img-replace">Close</a>    <div class="modal-header">                                       <h5 class="modal-title run_time_title" style="font-weight: bold;" >&nbsp;</h5>                  </div>                                   <div class="modal-body ajax_master_run" >				                                       </div>   </div> </div> 		   <div class="footer-area">
                                ...
                                <div class="widget-contact-info pb-6">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <a href="mailto:info@agriday.in">info@agriday.in</a>
                                        </li>
                                    </ul>
                                </div>
            ...
            <div class="footer-bottom py-3" data-bg-color="#bac34e">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="copyright">
                                <span class="copyright-text text-white">@ 2021 Agriday  All rights are reserved.
 </span>
                                <!--in Designed and Developed by Udyot Solutions-->
                            </div>
                        </div>
                    </div>
                </div>

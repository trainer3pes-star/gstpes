           ...
           <table id="example_php" class="table table-bordered table-striped col-xs-12" >
								...
								<tbody>
									...
									<tr  >
										...
										<td><?php if($result->user_id){ echo $result->username;}else{ echo $result->bank_name;}?></td>  
										<td><?php echo $result->comment;?></td> 
										<td><?php echo $result->bank_name;?></td>  
										<td><?php if($result->status==0){ echo "Pending (Query)"; }elseif($result->status==1){ echo "Approved"; }elseif($result->status==2){ echo "Rejected"; }?></td> 
										<td><?php echo date(DISPLAY_DATE_TIME,strtotime($result->created_date));?></td>

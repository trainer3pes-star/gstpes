...
<div class="row">
      <!-- Default box -->
	    <?php if($this->Home_model->check_permission('save_designation')){?>
    <div class="col-md-6">
	<?php echo form_open_multipart('admin/Master/save-designation', array('id' => 'master_frrm','class'=>'form-horizontal adminex-form' ,'enctype'=>'multipart/form-data')); ?>
	  <div class="card"> 	   
        ...
        <div class="card-body">
           <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">  Designation <label style="color:#FF0000">*</label></label>
                    <div class="col-sm-8">
        ...
        <div class="card-footer">
			...
			<?php if($result->id){
				if($this->Home_model->check_permission('save_designation')){?>
			...
			<?php if(@$result->id){?>
			<a style="float:right;width:40%" class="btn btn-secondary" href="Master/designation-list"><?php echo $this->lang->line('common_close_btn');?></a>
			<?php } ?>
        </div>
        <!-- /.card-footer-->
      </div>
		...
		<?php } ?>
	  <?php if($this->Home_model->check_permission('designation_list')){?>
	  <div class="col-md-6">
	<?php echo form_open_multipart('admin/Master/designation-list', array('id' => 'basic_search','class'=>'form-horizontal adminex-form' ,'enctype'=>'multipart/form-data')); ?>
	  <div class="card"> 	   
        <div class="card-header">
        ...
        <div class="card-body">
           <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">By Designation </label>
                    <div class="col-sm-8">
		...
		<div class="form-group row">
			...
			<div class="col-sm-6">
				<a style="float:right;width:100%" class="btn btn-success" href="Master/designation-list"><?php echo $this->lang->line('common_reset_btn');?></a>
			</div>
			</div>
        </div>
        <!-- /.card-footer-->
 ...
 <i style="cursor:pointer" class="fas fa-arrow-circle-down sorting_btn"  data-frm="basic_search" data-filed="TypeName" data-type="DESC"></i>
								...
								<tbody>
									...
									<tr>
										...
										<td><input type="checkbox" value="1"  data-msg="<?php echo $this->lang->line('admin_msg_status_updated');?>" data-confirm-msg="<?php echo $this->lang->line('admin_msg_status_update_confirm');?>"  class=" <?php if($this->Home_model->check_permission('save_designation')){?> update_status <?php } ?> " data-id="<?php echo $result->id?>" data-module="user_role_master"  data-filed="is_active" <?php if(@$result->is_active){?> checked <?php } ?>></td>
										<td>
										<?php if($this->Home_model->check_permission('save_designation')){?> 
										
										<a class="btn btn-xs btn-info" href="master/designation-list/<?php echo $result->id?>" title="Edit"><i class="fas fa-pencil-alt "></i></a>
										<?php }?>
										<?php  
										if($this->Home_model->check_permission('designation_delete')){?>
										<a class="btn btn-xs btn-danger confirm_delete" href="master/designation-delete/<?php echo $result->id?>" title="Delete"><i class="fa fa-trash"></i></a>
										<?php }?>
										</td>
									</tr>
									<?php } ?>

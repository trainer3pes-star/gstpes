...
<div class="row">
     ...
     <div class="col-md-2"></div>
	  <div class="col-md-8">
	<?php echo form_open_multipart('admin/order/seller-rejected-order-list', array('id' => 'basic_search','class'=>'form-horizontal adminex-form' ,'enctype'=>'multipart/form-data')); ?>
	  <div class="card"> 	   
...
<div class="col-sm-2" style="float:right;"> 
		  ...
		  <?php } ?>
		  <div class="col-sm-2" style="float:right;"> 
				<input  type="button"  id="approve_order_product" value="  Approve Order" class="btn btn-success  " style="width:100%;float:right" />
			</div>
 ...
 <i style="cursor:pointer" class="fas fa-arrow-circle-down sorting_btn"  data-frm="basic_search" data-filed="order_number" data-type="DESC"></i>
								...
								<tbody>
									...
									<tr  >
										...
										<td><?php if($result->is_seller_approved=='-1'){?> <input type="checkbox" name="order_id[]" class="sub_checkbox_check" title="Check All" value="<?php echo $result->id;?>"><?php } ?></td> 
										...
										<td><?php echo $result->reject_note;?></td> 
...
?>
  ...
  <input type="hidden" name="return_to" value="seller-rejected-order-list">

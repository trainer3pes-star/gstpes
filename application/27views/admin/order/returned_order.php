...
<div class="row">
     ...
     <div class="col-md-2"></div>
	  <div class="col-md-8">
	<?php echo form_open_multipart('admin/order/returned-order', array('id' => 'basic_search','class'=>'form-horizontal adminex-form' ,'enctype'=>'multipart/form-data')); ?>
	  <div class="card"> 	   
        ...
        <div class="card-body">
           <div class="form-group row"> 
			...
			<div class="col-sm-3"> 
			 <label for="inputEmail3" class="col-sm-12 col-form-label">&nbsp;</label>
				<a style="float:right;width:100%" class="btn btn-success" href="order/returned-order"><?php echo $this->lang->line('common_reset_btn');?></a>
			</div> 
                </div>
        </div>

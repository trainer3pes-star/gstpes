                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 pt-10 pt-lg-0">
						        <div class="login-form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <label>Role <label class="required_label">*</label></label>
										...
										<div class="col-md-6 col-12">
                                            <label>Password <label class="required_label">*</label></label>
										...
										<div class="col-md-6 col-12">
                                            <label>Confirm Password <label class="required_label">*</label></label>
                            ...
                            <br></br>
                                <div class="login-form company_other" style="display:none;">
 ...
 <br></br>
 <div class="login-form company_documnet_other" style="display:none;">

							 ...
							 <div class="col-lg-3 col-sm-6 pt-6">
									<div class="product-item">
										<div class="product-img img-zoom-effect"> 
											<a href="<?php echo PRODUCT_DETAIL?>/<?php echo $result->pro_alt?>/<?php echo base64_encode($result->detail_id)?>"> <img class="img-full" src="uploads/product/110X124/<?php echo $result->product_main_img;?>" alt="<?php echo $result->pro_name;?>"> </a> 
											<div class="product-add-action">
												<ul>
													<li>
														<a <?php if($login_user_info->id){?> href="javascript:void(0);" class="add_to_cart" <?php }else{ ?> href="<?php echo LOGIN_URL ?>"  <?php } ?>data-id="<?php echo $result->pro_id;?>" data-did="<?php echo $result->detail_id;?>"> <i class="pe-7s-cart"></i> </a>
													</li>
													<!--<li>
														<a href="compare.php"> <i class="pe-7s-shuffle"></i> </a>
													</li>-->
													<li>
														<a <?php if($login_user_info->id){?> href="javascript:void(0);" class="add_to_wishlist" <?php }else{ ?> href="<?php echo LOGIN_URL ?>"  <?php } ?>data-id="<?php echo $result->pro_id;?>" data-did="<?php echo $result->detail_id;?>"> <i class="pe-7s-like"></i> </a>
													</li>
												</ul>
											</div>
										</div>

                        ...
                        <div class="col-lg-6 pt-9 pt-lg-0">
                            <div class="single-product-content">
                                ...
                                <div class="price-box pb-1 discount_price_div <?php if($result->discount_amount==0){?> hide <?php }else{ ?> show <?php } ?>">
                                    <span class="new-price text-danger show_final_price"><?php echo $result->show_final_price?> Rs</span>
                                    <span class="old-price text-primary final_price"><?php echo $result->final_price?> Rs</span>
                                </div>
								<div class="price-box pb-1 sigle_price_div <?php if($result->discount_amount==0){?> show <?php }else{ ?> hide <?php } ?>">
                                    <span class="new-price text-danger show_final_price"><?php echo $result->final_price?> Rs</span> 
                                </div>
								...
								<?php } ?>
								<?php if(strlen($result->company_name)){?>
                                <p class="short-desc mb-6"> 
                                ...
                                <ul class="quantity-with-btn pb-7">
                                    ...
                                    <li class="add-to-cart">
                                        <a class="btn btn-custom-size lg-size btn-primary btn-secondary-hover rounded-0" href="cart.php">Add to cart</a>
                                    </li>
                                    <li class="wishlist-btn-wrap">
                                        <a class="btn rounded-0" href="wishlist.php">

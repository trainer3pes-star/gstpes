...
<div class="row">
     ...
     <div class="col-md-2"></div>
	  <div class="col-md-8">
	<?php echo form_open_multipart('admin/order/payment-approved-order', array('id' => 'basic_search','class'=>'form-horizontal adminex-form' ,'enctype'=>'multipart/form-data')); ?>
	  <div class="card"> 	   
        ...
        <div class="card-body">
           <div class="form-group row"> 
			...
			<div class="col-sm-3"> 
			 <label for="inputEmail3" class="col-sm-12 col-form-label">&nbsp;</label>
				<a style="float:right;width:100%" class="btn btn-success" href="order/payment-approved-order"><?php echo $this->lang->line('common_reset_btn');?></a>
			</div> 
                </div>
        </div>
 ...
 <i style="cursor:pointer" class="fas fa-arrow-circle-down sorting_btn"  data-frm="basic_search" data-filed="order_number" data-type="DESC"></i>
								...
								<tbody>
									...
									<tr  >
										...
										<td><?php echo $result->seller_mobile;?></td>  
										...
										<td><a  href="javascript:void(0);" class="order_detail_popup" data-id="<?php echo $result->id?>" data-seller-id="<?php echo $result->seller_id;?>"><?php echo $result->total_product;?></td>  

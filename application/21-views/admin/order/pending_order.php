...
<div class="row">
     ...
     <div class="col-md-2"></div>
	  <div class="col-md-8">
	<?php echo form_open_multipart('admin/order/pending-order', array('id' => 'basic_search','class'=>'form-horizontal adminex-form' ,'enctype'=>'multipart/form-data')); ?>
	  <div class="card"> 	   
           ...
           <div class="form-group row"> 
				   ...
				   <div class="col-sm-6">
					...
					<select name="seller_id" id="seller_id" class=" form-control select2 " style="width:100%;"> 
						...
						<option value="<?php echo $seller_rs->id?>" <?php if(@$search['seller_id']==$seller_rs->id){?> selected <?php } ?>><?php echo $seller_rs->name;?></option>
						<?php } ?>
						</select> 
			...
			<div class="col-sm-3"> 
			 <label for="inputEmail3" class="col-sm-12 col-form-label">&nbsp;</label>
				<a style="float:right;width:100%" class="btn btn-success" href="order/pending-order"><?php echo $this->lang->line('common_reset_btn');?></a>
			</div> 
                </div>
        </div>
...
<div class="col-sm-2" style="float:right;"> 
		  ...
		  <?php if($this->Home_model->check_permission('1','PExport')){?>
<div class="col-sm-2" style="float:right;"> 
				<input  type="button"  id="paymet_approve_order" value="Admin Approve Order" class="btn btn-success  " style="width:100%;float:right" />
			</div>
		<div class="col-sm-2" style="float:right;"> 
				<input  type="button"  id="payment_reject_order" value="Admin Reject Order" class="btn btn-danger  " style="width:100%;float:right" />
			</div>  
		  <?php } ?>
 ...
 <i style="cursor:pointer" class="fas fa-arrow-circle-down sorting_btn"  data-frm="basic_search" data-filed="order_number" data-type="DESC"></i>
								...
								<tbody>
									...
									<tr  >
										...
										<td><?php if($result->is_admin_approve!=1){?> <input type="checkbox" name="order_id[]" class="sub_checkbox_check" title="Check All" value="<?php echo $result->id;?>"><?php } ?></td> 
										<td><?php echo $result->order_number;?></td> 
										<td><?php echo date(DISPLAY_DATE_TIME,strtotime($result->order_date));?></td> 
										<td><?php echo ucwords($result->order_status);?></td>  
										<td><?php echo ucwords($result->payment_status);?></td>  
										<td><?php echo $result->name;?></td>  
										<td><?php echo $result->mobile;?></td>  
										<td><?php echo $result->email;?></td>  
										<td><?php echo $result->payment_mode;?></td>  
										<td><a  href="javascript:void(0);" class="order_payment_popup" data-id="<?php echo $result->id?>"><?php echo $result->total_cart_amount;?></a></td>  
										...
										<td><a  href="javascript:void(0);" class="order_detail_popup" data-seller-id="" data-id="<?php echo $result->id?>"><?php echo $result->total_product;?></td>  

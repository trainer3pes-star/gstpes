...
<div class="alert alert-danger alert-dismissible"  <?php if(@strlen($this->session->flashdata('errorsmsg'))){?> style="display:block" <?php }else{?> style="display:none" <?php } ?>>
      ...
      <!-- Default box -->
	  <?php echo form_open_multipart('admin/master/save-coupon', array('id' => 'basic_frm','class'=>'form-horizontal adminex-form' ,'enctype'=>'multipart/form-data')); ?>
	  <div class=" row">
    <div class="col-md-6">
	  ...
	  <div class="card">
       ...
       <div class="card-body">
				<div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">Coupon Title<label style="color:#FF0000">*</label></label>
                    <div class="col-sm-8">
						<input  type="text" class="form-control required    " name="coupon_title" id="coupon_title" maxlength="200"  value="<?php echo @$result->coupon_title?>">
				   </div>
                </div> 
				<div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">Coupon Code<label style="color:#FF0000">*</label></label>
                    <div class="col-sm-8">
						<input  type="text" class="form-control required no_space   " name="coupon_code" id="coupon_code" maxlength="200"  value="<?php echo @$result->coupon_code?>">
				   </div>
                </div> 
				<div class="form-group row">
        ...
        <div class="card-body">
		 <div class="form-group row">
				...
				<div class="form-group row">
				 ...
				 <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">Coupon For <label style="color:#FF0000">*</label></label>
                    <div class="col-sm-8">
						<select name="coupon_for" id="coupon_for" class=" form-control select2 coupon_for " style="width:100%;"> 
						<option value="1" <?php if(@$result->coupon_for==1){ ?> selected <?php } ?>> All Category</option> 
						<option value="2" <?php if(@$result->coupon_for==2){ ?> selected <?php } ?>> Specific Categories</option> 
						<option value="3" <?php if(@$result->coupon_for==3){ ?> selected <?php } ?>> Specific Products</option> 
						</select> 
				   </div>
                </div>	

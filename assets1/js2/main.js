...
---------------------------------*/
	...
	if($('.testimonial-slider2').elExists()){
		var mySwiper = new Swiper('.testimonial-slider2', {
			slidesPerView: 1,
			spaceBetween: 30,
			loop: true,
			autoplay: {
	...
	if($('.team-member-slider').elExists()){
		var mySwiper1 = new Swiper('.team-member-slider', {
			slidesPerView: 3,
			spaceBetween: 30,
			loop: true,
			navigation: {
	...
	if($('.single-product-slider').elExists()){
		var singleProduct = new Swiper('.single-product-thumbs', {
            ...
            navigation: {
              nextEl: ".next-slide_thum",
              prevEl: ".prev-slide_thum"
            }
		});
		var singleProduct1 = new Swiper('.single-product-slider', {
			autoplay: false,
			delay: 5000,
			slidesPerView: 1,
			slidesPerGroup: 1,
...
/*----------------------------------------*/
	...
	$('.qtybutton').on('click', function () {
		...
		var ele=$button.parent().find('input');
		if($(ele).hasClass('update_quantity')){
		    $(ele).trigger( 'change' ); 
		}
	});
